...
import com.dac.gapp.andac.databinding.FragmentMyBoardsBinding
...
class MyBoardsFragment : BaseFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        return inflate(inflater,R.layout.fragment_my_boards, container, false)
    }

    lateinit var binding: FragmentMyBoardsBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.recyclerView.adapter = BoardRecyclerAdapter(context, list, map, hospitalInfoMap)
        setAdapter()
    }
